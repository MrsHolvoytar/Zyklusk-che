export const S = {
  root: {
    ...
    background: "#EDE6DC", minHeight: "100vh", color: "#3A2F28",
  },
  card: {
    background: "#FFFDF9", borderRadius: 18, padding: 17,
    boxShadow: "0 1px 8px rgba(120,90,70,0.07)",
    marginBottom: 14, border: "1px solid rgba(180,150,130,0.22)",
  },
  h1: { margin: 0, fontSize: 20, fontWeight: 600, color: "#3A2F28", fontFamily: "'Baloo 2',sans-serif" },
  h2: { margin: "0 0 6px", fontSize: 18, fontWeight: 600, color: "#3A2F28", fontFamily: "'Baloo 2',sans-serif" },
  eyebrow: { fontSize: 10, letterSpacing: 2, color: "#9C8A78", textTransform: "uppercase", fontWeight: 700 },
  sub: { color: "#9C8A78", fontSize: 13, margin: "0 0 14px", lineHeight: 1.5 },
  label: { fontSize: 12.5, color: "#8A7765", display: "block", marginBottom: 6, letterSpacing: 0.3 },
  input: {
    ...
    fontFamily: "'Quicksand',sans-serif", color: "#3A2F28",
  },
  btn: (col, textCol) => ({
  ...
  pill: {
    ...
    fontFamily: "'Quicksand',sans-serif", color: "#6B5A48",
  },
  iBtn: {
  ...
  meta: {
    ...
    fontFamily: "'Quicksand',sans-serif", border: "1px solid rgba(180,150,130,0.2)",
  },
};
...
export function Spinner({ text="..." }) {
  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:14, padding:32 }}>
      ...
      <span style={{ color:"#9C8A78", fontSize:13, fontStyle:"italic" }}>{text}</span>
