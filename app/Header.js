    ...
    <div style={{ position:"relative" }}>
      ...
      {open && (
        <div style={{
          ...
          <div onClick={()=>setOpen(false)} style={{ fontSize:11, color:"#B3A3B6", textAlign:"center", cursor:"pointer" }}>
...
export function LangSwitch({ lang, onChange, onOpenProfile, onSetStartDate, accentColor = "#7A5E80" }) {
  return (
    <div style={{ display:"flex", justifyContent:"flex-end", alignItems:"center", gap:8, marginBottom:14 }}>
      ...
      <div style={{ display:"flex", background:"rgba(74,58,80,0.07)", borderRadius:999, padding:3 }}>
        {["de","en"].map(l => (
