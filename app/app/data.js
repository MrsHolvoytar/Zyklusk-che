...
export const TRANSLATIONS = {
  de: {
    ...
    background: "Hintergrund", select: "Auswählen", replace: "Ersetzen", selected: "Ausgewählt", deselect: "Abwählen",
    ...
    resetDay: "Manuell verschoben · Zurücksetzen", resetDayShort: "Zurücksetzen",
    persons: "Personen", forHowManyPersons: "Für wie viele Personen kochst du?",
    portionsPerPerson: "Portionen pro Person", portionsPerPersonHint: "Bei 1 kochst du jeden Tag neu. Ein höherer Wert lässt ein Rezept für mehrere Tage reichen.",
  ...
  en: {
    ...
    background: "Background", select: "Select", replace: "Replace", selected: "Selected", deselect: "Deselect",
    ...
    resetDay: "Manually shifted · Reset", resetDayShort: "Reset",
    persons: "People", forHowManyPersons: "How many people are you cooking for?",
    portionsPerPerson: "Servings per person", portionsPerPersonHint: "At 1, you cook fresh every day. A higher value makes one recipe last several days.",
