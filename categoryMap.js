...
export default function BottomNav({ active, onChange, phaseColor, lang }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        width:"100%", maxWidth:548, background:"#FFFEFC", borderRadius:24,
        border:"1px solid rgba(160,140,170,0.22)", padding:"10px 6px",
        display:"flex", justifyContent:"space-around",
        boxShadow:"0 6px 20px rgba(120,95,130,0.13)",
      }}>
